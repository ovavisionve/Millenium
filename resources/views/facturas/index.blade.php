                            ...
                            @forelse ($facturas as $f)
                                ...
                                <tr class="text-gray-900 dark:text-gray-100">
                                    ...
                                    <td class="px-3 py-2 text-end whitespace-nowrap">
                                        <a href="{{ route('facturas.show', $f) }}" class="text-indigo-600 dark:text-indigo-400 hover:underline">Ver</a>
                                        <a href="{{ route('facturas.edit', $f) }}" class="text-indigo-600 dark:text-indigo-400 hover:underline ms-2">Editar</a>
                                    </td>
                                </tr>
                            @empty
                                <tr><td colspan="10" class="px-4 py-8 text-center text-gray-500">No hay facturas.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
