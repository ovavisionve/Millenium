<x-app-layout>
    ...
    <div class="py-6" x-data="{ lineas: @js($lineasForm) }">
                ...
                <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6 space-y-4">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <x-text-input id="numero_factura" name="numero_factura" type="text" class="mt-1 block w-full font-mono" :value="old('numero_factura', $factura->numero_factura)" />
