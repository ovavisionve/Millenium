<x-app-layout>
    ...
    @php
    $defaultLineas = old('lineas', [$lineaVacia]);
    $clienteIdInicial = old('cliente_id') !== null && old('cliente_id') !== '' ? (string) old('cliente_id') : '';
    $vendedorIdInicial = old('vendedor_id') !== null && old('vendedor_id') !== '' ? (string) old('vendedor_id') : '';
    @endphp
    ...
    <div
        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 space-y-4">
            <p class="text-sm text-gray-600 dark:text-gray-300">
                Carga manual de control: <strong>fecha</strong>, <strong>cliente</strong>, <strong>vendedor de la factura</strong> (reportes), <strong>cómo indicó el cliente que va a pagar</strong>, <strong>observaciones</strong> opcionales, <strong>días de crédito</strong> y líneas con
                <strong>categoría</strong> (línea de venta), <strong>cantidad de animales</strong> (opcional por línea), <strong>unidad/Kilos</strong> y <strong>precio real</strong> según definas la categoría en maestros. Al guardar, la factura alimenta la cartera “en la calle” y la cartera se clasifica (vencida / por vencer / al día).
            </p>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6 space-y-4">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Quién gestiona la venta en esta factura. Al elegir cliente se sugiere el vendedor del maestro; podés corregirlo.</p>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <x-text-input
                                ...
                                maxlength="64"
                                :value="old('numero_factura', $siguienteNumeroFactura)"
                                required
                                autocomplete="off" />
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                Ingresá el número que figure en el documento físico o de control. Debe ser <strong>único</strong> en el sistema.
                                Sugerencia (siguiente correlativo numérico estimado): <span class="font-mono">{{ $siguienteNumeroFactura }}</span>.
                                El piso del correlativo sugerido se ajusta con <code class="text-xs bg-gray-200 dark:bg-gray-700 px-1 rounded">MILLENNIUM_FACTURA_NUMERO_INICIAL</code> en <code class="text-xs">.env</code>.
                            </p>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <select id="metodo_pago_previsto" name="metodo_pago_previsto" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm">
                                ...
                                <option value="{{ $val }}" @selected((string) old('metodo_pago_previsto', '' )===(string) $val)>{{ $label }}</option>
                                @endforeach
                            </select>
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Misma lista que en cobranza (referencia al cargar la factura; el pago efectivo se registra después).</p>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea
                                ...
                                placeholder="Notas al cliente, condiciones acordadas, entregas, etc. (opcional)">{{ old('observaciones') }}</textarea>
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Queda guardado en la factura y en el PDF/documento de deuda si hay texto.</p>
                        ...
                        <table class="min-w-full text-sm">
                            ...
                            <tfoot>
                                <tr class="border-t-2 border-millennium-dark/20 dark:border-millennium-sand/30 bg-gray-50/80 dark:bg-gray-900/50">
                                    <td colspan="4" class="px-2 py-3 text-end font-semibold text-gray-800 dark:text-gray-100">Total USD (saldo inicial de la factura)</td>
