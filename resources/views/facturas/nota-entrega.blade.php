...
<head>
    ...
    <title>Nota de entrega {{ $factura->numero_factura ?? $factura->id }} — {{ config('app.name') }}</title>
    <style>
...
<body>
    <div class="ne-toolbar">
        ...
        <a class="primary" href="{{ route('facturas.nota-entrega.pdf', $factura) }}">Descargar PDF</a>
    </div>
